...
}' > src/router/LazyLoad/loader.module.css

echo "import styles from './loader.module.css'
...
function Loader() {
  return (
    <div className={'fixed left-0 top-0 h-1 w-full bg-gray-400'}>
      <div
        className={
...
echo 'const NotFoundPage: React.FC = () => {
  return (
...
export default NotFoundPage' > src/views/404/page.tsx

npm pkg set scripts.route="node ./src/lib/createRouter.cjs"
...
createRouter()' > src/lib/createRouter.cjs
