...
npm i -D tailwindcss@latest postcss@latest autoprefixer@latest prettier-plugin-tailwindcss sass
...
```bash
npm i  lodash
npm i -D  mockjs @types/mockjs vite-plugin-pages  @types/lodash
